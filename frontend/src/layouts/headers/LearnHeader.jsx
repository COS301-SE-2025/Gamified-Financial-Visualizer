...
import { FaSearch, 	FaBook, FaLayerGroup, FaChalkboardTeacher } from 'react-icons/fa';
  ...
  return (
    ...
    // Search main box
      ...
      <div className="flex space-x-2">
        ...
        >
          <FaBook className="text-md" /> Course
        </button>
        ...
        >
          <	FaLayerGroup className="text-md" /> Modules
        </button>
        ...
        >
          <FaChalkboardTeacher className="text-md" /> Lessons
        </button>
      </div>
    </div>
  );
