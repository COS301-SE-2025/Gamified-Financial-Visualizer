    ...
    <div className="flex justify-between items-center px-6 py-4 bg-white border-b shadow rounded-xl">
      ...
      <div className="flex space-x-2">
        <button
          ...
          className={`px-4 py-2 border rounded-xl shadow flex items-center gap-2 transition-all duration-200 ${path.includes('/goals/create') ? 'bg-[#88BC46] text-white' : 'bg-white text-gray-600'
            }`}
        >
