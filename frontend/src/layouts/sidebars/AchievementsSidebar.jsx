...
const AccountsSidebar = () => {
  ...
  const offset = circumference * (1 - userStats.performance / 100);
      ...
      <div className="bg-white rounded-2xl p-4 shadow text-center">
        ...
        <div className="relative w-40 h-40 mx-auto">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <p className="text-2xl font-bold text-[#2D3748]">{userStats.creditScore}</p>
            <p className="text-sm text-[#718096]">{userStats.performanceLabel}</p>
            <img
        ...
        <p className="text-sm text-[#F56565] mt-3 font-medium"> Lv {levelProgress?.level_number ?? '—'}: {levelProgress?.tier_status ?? '—'}</p>
      </div>
