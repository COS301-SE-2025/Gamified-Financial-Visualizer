...
const AccountsPerformanceHeader = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(`${BASE_URL}/api/learning/summary/${id}`);
  ...
  return (
     <div className="w-full mb-6">
      ...
      {/* Desktop Header - FIXED: removed "hidden lf:flex" and used proper class */}
          ...
          <div className="bg-white rounded-2xl shadow-md p-4 flex flex-col sm:flex-row items-center justify-between gap-6 dark:bg-gray-800">
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">{performance.level}</p>
