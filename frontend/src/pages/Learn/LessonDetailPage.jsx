  ...
  const renderLessonContent = (lesson) => {
    return (
      <div className="mt-4 space-y-4 animate-fadeIn">
        <div className="prose prose-sm max-w-none text-gray-700 dark:text-gray-300 leading-relaxed whitespace-pre-line text-sm md:text-base">
          {lesson.content}
        </div>
    ...
    <LearnLayout>
      {showCompletion && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 max-w-md w-full text-center animate-zoomIn mx-4">
            <div className="bg-gradient-to-br from-[#FFC54120] to-[#FFC54110] dark:from-[#FFC54110] dark:to-[#FFC54105] w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center mx-auto mb-4 shadow-inner">
              <FaTrophy className="text-[#FFC541] text-2xl md:text-3xl" />
            </div>
            <h3 className="text-lg md:text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Module Complete!</h3>
            ...
            <div className="flex flex-col gap-2">
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-[#5FBFFF] to-[#B1E1FF] dark:from-[#4FAFFF] dark:to-[#A1D1FF] text-white rounded-lg font-medium hover:from-[#4FAFFF] hover:to-[#A1D1FF] dark:hover:from-[#3F9FFF] dark:hover:to-[#91C1FF] transition-all shadow text-sm md:text-base"
              >
                Continue Learning
              </button>
              <button
                onClick={() => navigate('/learn')}
                className="px-4 py-2 bg-white border border-gray-200 dark:border-gray-600 rounded-lg font-medium hover:bg-gray-50 dark:hover:bg-gray-600 transition-all dark:text-gray-800 text-sm md:text-base"
              >
                Back to Courses
              </button>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="bg-gradient-to-r from-[#B1E1FF20] to-[#7FDD5320] 
                      ...
                      rounded-xl p-4 sm:p-6 mb-6 shadow-sm border border-gray-100 dark:border-gray-700/50">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 sm:gap-4">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 leading-relaxed">{moduleDescription}</p>
            </div>
            <button
              onClick={() => navigate(-1)}
              className="w-full md:w-auto px-4 py-2 bg-white border border-gray-200 rounded-lg font-medium text-gray-700 hover:bg-gray-50 transition-colors shadow-sm flex items-center justify-center gap-2 mt-3 md:mt-0 text-sm sm:text-base"
            >
              ...
              >
                <div className="flex items-start gap-3 sm:gap-4 flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1 flex flex-wrap items-center gap-1 sm:gap-2">
                ...
                <div className="ml-2 flex-shrink-0 mt-1 sm:mt-0">
        ...
        {quizData && (
          <div className="mt-8 sm:mt-12">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4 sm:mb-6 flex items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 sm:h-5 sm:w-5 text-[#B1E1FF] dark:text-[#AAD977]" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd" />
              </svg>
              Module Quiz
            </h2>
                  ...
                  {!quizSubmitted ? (
                    <div className="space-y-4 sm:space-y-6">
                      {quizData.questions_jsonb.map((question, qIndex) => (
                        <div key={qIndex} className="bg-gray-50 dark:bg-gray-700 p-3 sm:p-5 rounded-lg border border-gray-100 dark:border-gray-600">
                          <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-2 sm:mb-3 text-sm sm:text-base">
                            <span className="text-gray-500 dark:text-gray-400 mr-1 sm:mr-2">Q{qIndex + 1}:</span>
                            {question.question} 
                            <span className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 ml-1 sm:ml-2">({question.points} point{question.points !== 1 ? 's' : ''})</span>
                          </h4>
                          <div className="space-y-2 sm:space-y-3">
                            {question.options.map((option, oIndex) => (
                              <div
                                key={oIndex}
                                className="flex items-center space-x-2 sm:space-x-3 cursor-pointer group p-2 sm:p-3 rounded-lg hover:bg-gray-100 transition-colors"
                              ...
                              >
                                ...
                                <span className="text-xs sm:text-sm text-gray-700 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-gray-100 transition-colors break-words flex-1">{option}</span>
                              </div>
                            ))}
                          </div>
                        </div>
                      ...
                      <button
                        ...
                        className={`w-full mt-4 sm:mt-6 px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-medium text-base sm:text-lg transition-all ${Object.keys(quizAnswers).length === quizData.questions_jsonb.length
                    ...
                    <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-lg text-center border border-gray-100 dark:border-gray-700">
                      ...
                      <div className="text-lg sm:text-xl font-medium mb-3 sm:mb-4">
                      ...
                      <div className="mb-4 sm:mb-6 text-gray-600 dark:text-gray-400 max-w-md mx-auto text-xs sm:text-sm">
                        <p>
                          {quizScore >= quizData.pass_score
                      ...
                      <div className="flex flex-col sm:flex-row justify-center gap-2 sm:gap-3">
                        <button
                          onClick={resetQuiz}
                          className="px-4 sm:px-6 py-2 bg-[#B1E1FF20] dark:bg-[#AAD97720] text-[#5FBFFF] dark:text-[#7FDD53] rounded-lg font-medium hover:bg-[#B1E1FF30] dark:hover:bg-[#AAD97730] transition-colors text-xs sm:text-sm"
                        >
                          Retake Quiz
                        </button>
                        <button
                          onClick={() => navigate('/learn')}
                          className="px-4 sm:px-6 py-2 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors text-xs sm:text-sm"
                        >
                          Continue Learning
                        </button>
                      </div>
