      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 md:mb-8 gap-3 md:gap-4">
          ...
          <div className="flex items-center gap-2">
            <span className="inline-flex items-center px-2 py-1 sm:px-3 sm:py-1 rounded-full text-xs font-medium bg-[#5FBFFF20] dark:bg-[#1E40AF30] text-[#5FBFFF] dark:text-[#93C5FD]">
