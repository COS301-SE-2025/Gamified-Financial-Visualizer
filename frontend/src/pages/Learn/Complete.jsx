      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 sm:mb-8 gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-2">
            <span className="inline-flex items-center px-2 sm:px-3 py-1 rounded-full text-xs font-medium bg-[#7FDD5320] dark:bg-[#14532D] text-[#7FDD53] dark:text-[#86EFAC]">
