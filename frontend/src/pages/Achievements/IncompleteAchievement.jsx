      ...
      <div className="space-y-6 px-6 pt-10 pb-6 -mt-8">
        {/* Banner - mobile responsive */}
         <div className="bg-gradient-to-r from-[#B1E1FF20] to-[#7FDD5320] rounded-xl p-4 sm:p-6 mb-4 sm:mb-6 shadow-sm border border-gray-100 dark:border-gray-700">
          <div>
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-2 dark:text-gray-200">Inompleted Achievements</h1>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300">You’re close! Keep pushing to finish these</p>
