    ...
    return (
        <CommunityLayout>
            <div className="max-w-4xl mx-auto space-y-4 px-3 sm:px-4 dark:bg-gray-900">
                {/* Header Section - Made smaller for mobile */}
                ...
                {/* Challenge banner - Side-by-side layout for both mobile and desktop */}
                <div className="bg-white dark:bg-gray-800 p-3 sm:p-4 rounded-2xl shadow border border-[#E5E7EB] dark:border-gray-700 flex flex-row items-start gap-3">
                    <img
                        src={bannerImg}
                    ...
                    <div className="flex-1 space-y-1 text-left">
                        ...
                        <p className="text-xs text-[#6B7280] dark:text-gray-400">{challengeData.community_name}</p>

                        {/* Challenge tags - Made smaller for mobile */}
                ...
                {/* Progress bar section - Made smaller for mobile */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                    <div className="bg-white dark:bg-gray-800 p-3 sm:p-4 rounded-xl shadow border border-[#E5E7EB] dark:border-gray-700">
                        <h4 className="text-xs font-semibold mb-1.5 text-[#1F2937] dark:text-gray-200">{challengeData.challenge_type}</h4>
                        <div className="flex items-center justify-between gap-2">
                            ...
                            <span className="text-xs font-semibold text-[#F97316] whitespace-nowrap">{challengeData.target_amount}</span>
                        </div>
                        <p className="text-xs mt-1 text-right text-[#6B7280] dark:text-gray-400">Spending Target</p>
                    </div>

                    {/* Deadline details - Made smaller for mobile */}
                    <div className="bg-white dark:bg-gray-800 p-3 sm:p-4 rounded-xl shadow border border-[#E5E7EB] dark:border-gray-700">
                        <h4 className="text-xs font-semibold mb-1.5 text-[#1F2937] dark:text-gray-200">Deadline</h4>
                        <div className="flex items-center gap-1.5 text-xs text-[#374151] dark:text-gray-300 justify-start">
                ...
                {/* Challenge members - Made smaller for mobile */}
                <div className="bg-white dark:bg-gray-800 p-3 sm:p-4 rounded-xl shadow border border-[#E5E7EB] dark:border-gray-700">
                    <h4 className="text-xs font-semibold mb-2 sm:mb-3 text-[#1F2937] dark:text-gray-200 text-left">Participants</h4>
                    <div className="flex flex-wrap justify-start gap-2 sm:gap-3">
                        ...
                        <span className="text-xs text-[#6B7280] dark:text-gray-400 self-center ml-1">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mt-4">
                    <p className="text-xs text-[#374151] max-w-xl text-left">
