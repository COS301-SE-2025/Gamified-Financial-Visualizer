            ...
            <div className="max-w-6xl mx-auto space-y-6 px-2 sm:px-4 dark:bg-gray-900">
                    ...
                    <div className="flex-1 space-y-2">
                        ...
                        <div className="flex flex-wrap gap-3 mt-4">
                            ...
                            <span className={`px-3 py-1 text-xs font-medium rounded-full ${
                                challengeData.days_until_due < 0 
                                    ? 'bg-[#FE9B90] text-[#FFFFFF]' 
                                    : 'bg-[#AAD977] text-[#FFFFFF]'
                            }`}>
                                {challengeData.days_until_due < 0 
                                    ? Math.abs(challengeData.days_until_due) + ' days OVERDUE' 
                                    : challengeData.days_until_due + ' days left'}
                            </span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow border border-[#E5E7EB] dark:border-gray-700">
                        ...
                        <p className="text-xs mt-1 text-right text-[#6B7280] dark:text-gray-400">Savings Target</p>
                    </div>
