        ...
        <div className="bg-white p-6 rounded-3xl shadow flex flex-col gap-4 mt-14">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-semibold text-gray-800">Lv {levelProgress?.tier_status ?? '—'}</p>
                <p className="text-sm text-gray-500">{levelProgress
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-center mb-1">
                        <h3 className="font-medium text-gray-800">{item.achievement_title}</h3>
        ...
        <div className="bg-white p-6 rounded-3xl shadow-md">
          ...
          <div className="space-y-4">
            {communityData.length === 0 ? (
              <p className="text-sm text-gray-500 italic text-center">No communities yet.</p>
            ) : (
