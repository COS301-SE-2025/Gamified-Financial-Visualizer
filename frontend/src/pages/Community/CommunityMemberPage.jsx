      ...
      <div className="max-w-6xl mx-auto space-y-4 sm:space-y-6 px-3 sm:px-4 py-4 dark:bg-gray-900">
        ...
        <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-2xl sm:rounded-3xl shadow flex flex-col gap-3 sm:gap-4 mt-12 sm:mt-14">
          ...
          <div className="relative mt-1 sm:mt-2">
            <div className="w-full h-4 sm:h-6 bg-yellow-100 dark:bg-[#FFD18C] rounded-full overflow-hidden">
              <div
            ...
            <div className="absolute inset-0 flex justify-center items-center text-xs sm:text-sm font-semibold text-yellow-700 dark:text-[#CF6108]">
              {levelProgress
          ...
          <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-2xl shadow-sm">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
              {[
                ...
                <div key={i} className="bg-gray-50 dark:bg-gray-700 rounded-xl p-2 sm:p-3 text-center">
          ...
          <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-2xl shadow-sm">
            ...
            <div className="space-y-3 sm:space-y-4">
              {recentAchievements.length === 0 ? (
                <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 italic text-center">No achievements yet.</p>
              ) : (
                recentAchievements.map((item, i) => (
                  ...
                  >
                    <img
                      ...
                      className="w-12 h-12 sm:w-16 sm:h-16 object-contain rounded-full flex-shrink-0"
                    />
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-1 gap-1">
                        ...
                        <span className="text-xs bg-[#fef9c3] dark:bg-[#FFD18C] dark:text-[#CF6108] text-[#92400e] px-2 py-1 rounded-full border border-[#fde047] whitespace-nowrap">
                          +{item.xp_reward} XP
                        </span>
                      </div>
                      <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 italic line-clamp-2">{item.detail}</p>
                    </div>
                  </div>
                )))}
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-2xl sm:rounded-3xl shadow-md">
          ...
          <div className="space-y-3 sm:space-y-4">
            {communityData.length === 0 ? (
              <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 italic text-center">No communities yet.</p>
            ) : (
              communityData.map((community, i) => (
                <div
                  key={i}
                  className="flex flex-col sm:flex-row sm:justify-between sm:items-center bg-white dark:bg-gray-700 shadow-md rounded-2xl p-3 sm:p-4 gap-3 sm:gap-0"
                >
                  <div className="flex items-center gap-3 sm:gap-4">
                    <img
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-2 sm:gap-4">
                    ...
                    <Link to={`/community/details/${community.community_name.toLowerCase().replace(/\s+/g, '_')}`}>
                      <button className="flex items-center gap-1 bg-[#AAD977] text-white font-medium text-xs sm:text-sm px-3 py-1 sm:px-4 sm:py-1.5 rounded-full hover:bg-[#83AB55] transition-all dark:bg-[#BBE48E] whitespace-nowrap">
