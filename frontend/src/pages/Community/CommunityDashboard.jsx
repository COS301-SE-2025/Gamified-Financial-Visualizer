...
import avatar2 from '../../assets/Images/avatars/BeachShore.png';
  ...
  return (
    <CommunityLayout>
      <div className="p-6 max-w-8xl mx-auto space-y-6">
        ...
        <div className="relative overflow-hidden bg-gradient-to-r from-[#B1E1FF] via-[#B4CB98] to-[#FFEFBD] p-6 rounded-3xl shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm bg-[#AAD977] text-white rounded-full shadow hover:bg-[#83AB55] transition"
            >
              <FaPen /> Create Post
            </button>
            ...
            {posts.map((post) => (
              <div
                key={post.id}
                className="bg-white rounded-3xl shadow-md p-6 space-y-4 border border-gray-100 hover:shadow-xl transition-all"
              >
                {/* Post Header */}
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <Link
                        ...
                        className="font-semibold text-gray-800 hover:text-[#72C1F5]"
                      >
                        {post.user.name}
                      </Link>
                ...
                <div className="flex justify-between items-center pt-3 border-t border-gray-100">
                  <div className="flex items-center gap-4 text-sm text-gray-500">
                    ...
                    <button className="flex items-center gap-1 hover:text-[#72C1F5]">
                      <FaComment />
                      <span>{post.comments.length}</span>
                    </button>
                    <button className="flex items-center gap-1 hover:text-[#88BC46]">
                      <FaShare />
                    </button>
                  </div>
                  <Link
      ...
      {showCreatePost && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white w-full max-w-2xl p-6 rounded-3xl shadow-xl border border-gray-100 relative space-y-4">
            ...
            <textarea
              ...
              className="w-full p-4 border border-gray-300 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-[#88BC46]"
            ></textarea>
            ...
            <div>
              ...
              <input
                type="file"
                accept="image/*"
                className="w-full text-sm text-gray-600 file:mr-4 file:py-1.5 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#E0F2FE] file:text-[#4B82A2] hover:file:bg-[#B1E1FF]"
            ...
            <div className="flex justify-end pt-2">
              <button
                ...
                className="bg-gradient-to-r from-[#88BC46] to-[#AAD977] text-white font-semibold px-6 py-2 rounded-full hover:opacity-90 transition shadow"
              >
                Post
              </button>
            </div>
