...
const COLORS = {
  ...
  expense: '#5FBFFF',
  average: '#FFC541',
  averageExpense: '#F68D2B',
  averageIncome: '#FF7F9E',
  forecast: '#7FDD53',
  savings: '#5FBFFF',
  budget: '#FF8A8A',
  checking: '#FFC541',
  ...
  total: "#7FDD53",
  forecast: "#FF7F9E",
  vol: "rgba(124,58,237,0.25)",
  deltaPos: "#7FDD53",
  deltaNeg: "#FF8A8A",
  cats: ["#FF8A8A", "#7FDD53", "#5FBFFF", "#FFC541", "#F68D2B"]
};
  ...
  const transformDayElement = (element, value) => {
    if (!value) {
      return React.cloneElement(
        element,
        {
          className: "fill-gray-100 hover:stroke-indigo-600 hover:stroke-2 transition cursor-default",
  ...
  return (
    <AccountsLayout>
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8 space-y-6 sm:space-y-8 dark:bg-gray-900">
            ...
            <div className="border-t pt-4 mt-4 border-gray-200 dark:border-gray-700">
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 mb-3">
                <h3 className="font-bold text-gray-800 dark:text-white flex items-center gap-2 text-sm sm:text-base">
                  <FaLightbulb className="text-yellow-400 dark:text-yellow-500 text-sm sm:text-base" /> 
                  Analysis for: "{aiResponse.prompt}"
                </h3>
                <span className="text-xs text-gray-500 dark:text-gray-400">{aiResponse.generatedAt}</span>
              </div>

              <div className="bg-indigo-50 p-3 sm:p-4 rounded-lg mb-4 border-l-4 border-indigo-400 text-sm sm:text-base">
              ...
              <ul className="space-y-2 pl-2">
                {aiResponse.actionItems.map((item, index) => (
                  <li key={index} className="flex items-start gap-2 text-sm sm:text-base">
                    <FaCheckCircle className="text-indigo-500 mt-1 flex-shrink-0 text-xs sm:text-sm" />
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <button
                    ...
                    className="bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 px-2 sm:px-3 py-1 rounded-lg text-xs sm:text-sm transition-colors duration-200 border border-gray-200 dark:border-gray-600"
                  >
                    {quickPrompt}
                  </button>
                ))}
        ...
        {/* Motivational Summary - Mobile Optimized */}
        <div className="bg-white dark:bg-gray-800 text-black dark:text-gray-200 p-4 sm:p-6 rounded-xl shadow-lg">
          <h2 className="text-lg sm:text-xl font-bold mb-4">Your Financial Standing</h2>
        ...
        {/* AI-Generated Monthly Summary - Mobile Optimized */}
        <div className="bg-white dark:bg-gray-800 dark:text-gray-200 text-black p-4 sm:p-6 rounded-xl shadow-lg">
          <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
            <div className="flex-1">
              <h2 className="text-lg sm:text-xl font-bold mb-3 text-black dark:text-gray-200">AI-Generated Financial Summary</h2>
            ...
            <div className="bg-[#7FDD53]/20 p-2 sm:p-3 rounded-full text-[#7FDD53] self-center">
        ...
        {/* 2-Column Layout for Charts - Mobile Stacked */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">

          {/* Sentiment - Mobile Optimized */}
            ...
            <div className="flex flex-col items-center">
              ...
              {!!sentiment?.tips?.length && (
                <div className="mt-4 w-full">
                  ...
                  <ul className="text-xs sm:text-sm dark:text-gray-200 text-gray-700 list-disc pl-4 space-y-1">
          ...
          {/* Monthly Spending by Category Bar Chart - Mobile Optimized */}
          <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-xl shadow-md border dark:border-gray-800 border-gray-200">
            <div className="flex flex-col gap-3 mb-4 sm:mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
                <div className="w-full sm:w-auto">
                  <label htmlFor="account-select" className="block text-xs sm:text-sm font-medium dark:text-gray-200 text-gray-700 mb-1">
                    Account
                  </label>
                  <select
                    id="account-select"
                    ...
                    className="w-full border dark:border-gray-700 dark:bg-gray-700 border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-sm"
                  >
                ...
                <div className="w-full sm:w-auto">
                  <label className="block text-xs sm:text-sm font-medium dark:text-gray-200 text-gray-700 mb-1">Scale</label>
                  <div className="inline-flex rounded-md overflow-hidden border dark:border-gray-700 border-gray-300 w-full sm:w-auto">
                    <button
                      type="button"
                      disabled={!showAvg}
                      onClick={() => setViewPercent(false)}
                      className={`flex-1 px-3 py-1.5 text-xs sm:text-sm ${!viewPercent ? "bg-indigo-100 text-indigo-700" : "bg-white dark:bg-gray-700 dark:text-gray-200 text-gray-700"} ${showAvg ? "opacity-50 cursor-not-allowed" : ""}`}
                    ...
                    <button
                      ...
                      className={`flex-1 px-3 py-1.5 text-xs sm:text-sm border-l border-gray-300 ${viewPercent ? "bg-indigo-100 text-indigo-700" : "bg-white text-gray-700"} ${showAvg ? "opacity-50 cursor-not-allowed" : ""}`}
                      title={showAvg ? "Disable Global Avg to use % view" : ""}
                    >
                      %
                    </button>
            ...
            <div className="w-full mb-3">
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1 px-2 py-1 text-xs rounded-md bg-gray-100 dark:bg-gray-700 dark:text-gray-200 text-gray-700 hover:bg-gray-200"
                  aria-expanded={catOpen}
                  aria-controls="category-panel"
                >
                  {catOpen ? "Hide" : "Show"} ({selectedCategories.length})
                  <svg
                    className={`h-3 w-3 transition-transform dark:text-gray-200 ${catOpen ? "rotate-180" : ""}`}
              ...
              <div
                id="category-panel"
                className={`overflow-hidden transition-[max-height,opacity] duration-300 ease-in-out ${catOpen ? "max-h-[320px] opacity-100 mt-2" : "max-h-0 opacity-0"}`}
              >
                <div className="flex flex-wrap items-center gap-2 mb-3">
                  ...
                  <button
                    type="button"
                    onClick={clearAll}
                    className="px-2 py-1 text-xs rounded-md bg-gray-100 dark:bg-gray-700 dark:text-gray-200 text-gray-700 hover:bg-gray-200"
                  >
                    Clear
                  </button>
                </div>
                  ...
                  {filteredCategories.map((category) => {
                    ...
                    return (
                      <button
                        ...
                        className={`px-3 py-1 text-xs rounded-lg flex items-center ${active ? "bg-indigo-100 text-indigo-700" : "bg-gray-100 dark:bg-gray-700 dark:text-gray-200 text-gray-700"}`}
                        title={category}
                      >
                        <span
                        ...
                        />
                        {category.charAt(0).toUpperCase() + category.slice(1).substring(0, 12)}
                        {category.length > 12 ? '...' : ''}
                      </button>
                    );
                  })}
                  {filteredCategories.length === 0 && (
                    <span className="text-xs dark:text-gray-200 text-gray-500">No categories match your search.</span>
                  )}
                </div>
              </div>

              {!catOpen && selectedCategories.length > 0 && (
                <div className="mt-2 flex flex-wrap items-center gap-1 text-xs dark:text-gray-200 text-gray-600">
                  <span className="opacity-70">Selected:</span>
                  {selectedCategories.slice(0, 4).map(c => (
                    <span key={c} className="px-1.5 py-0.5 rounded-full dark:bg-gray-700 bg-gray-100 text-xs">
                      {c.substring(0, 8)}
                      {c.length > 8 ? '...' : ''}
                    </span>
                  ))}
            ...
            <div className="h-64 sm:h-80 mt-4">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <YAxis tickFormatter={(v) => (viewPercent && !showAvg ? `${Math.round(Number(v) * 100)}%` : ZAR(v))} fontSize={11} />
                  <Tooltip
                    content={({ active, payload, label }) => {
                      ...
                      return (
                        <div className="rounded-xl border dark:bg-gray-700 border-gray-200 bg-white/90 backdrop-blur px-3 py-2 shadow text-xs">
                          ...
                          {payload.filter((p) => selectedCategories.includes(p.dataKey)).map((p) => {
                            ...
                            return (
                              <div key={cat} className="flex items-center gap-2 text-xs">
                                ...
                                />
                                <span className="text-gray-600 dark:text-gray-200 truncate max-w-[80px]">
                                  {cat.charAt(0).toUpperCase() + cat.slice(1)}
                                </span>
                                <span className="ml-auto font-medium dark:text-gray-200 text-gray-800 text-xs">{userDisplay}</span>
                                <span className="ml-1 text-gray-500 text-xs">Avg: {avgDisplay}</span>
                              </div>
                            );
                          })}
                        </div>
            ...
            {showAvg && (
              <div className="mt-2 text-xs dark:text-gray-200 text-gray-500">
                The dashed line shows the global average total for your selected categories each month.
              </div>
            )}
          </div>

          {/* Income vs Expense Bar Chart - Mobile Optimized */}
          <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-xl shadow-md border dark:border-gray-800 border-gray-200">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <button
                  ...
                  className={`px-2 py-1 text-xs sm:text-sm rounded-md ${viewMode === "overall"
                ...
                <button
                  ...
                  className={`px-2 py-1 text-xs sm:text-sm rounded-md ${viewMode === "byAccount"
                    ? "bg-indigo-100 text-indigo-700"
                ...
                {viewMode === "byAccount" && (
                  <select
                    ...
                    className="px-2 py-1 text-xs sm:text-sm rounded-md border border-gray-300 dark:text-gray-200 dark:bg-gray-700 bg-white"
                  >
            ...
            <div className="h-64 sm:h-80">
              <ResponsiveContainer width="100%" height="100%">
                <ComposedChart data={monthlyData} margin={{ top: 10, right: 10, left: 5, bottom: 5 }}>
                  <CartesianGrid strokeDasharray="3 3" stroke={COLORS.grid} />
                  <XAxis dataKey="month" tick={{ fontSize: 11, fill: "#6b7280" }} />
                  <YAxis tickFormatter={(v) => `R${Number(v).toLocaleString()}`} tick={{ fontSize: 10, fill: "#6b7280" }} />
            ...
            <div className="mt-3 flex flex-wrap justify-center gap-3">
              <div className="flex items-center text-xs">
                <span className="w-2 h-2 rounded-full mr-1" style={{ background: COLORS.income }} />
                <span>Income</span>
              </div>
              <div className="flex items-center text-xs">
                <span className="w-2 h-2 rounded-full mr-1" style={{ background: COLORS.expense }} />
                <span>Expenses</span>
              </div>
              <div className="flex items-center text-xs">
                <span className="w-2 h-2 rounded-full mr-1 border border-gray-300" style={{ background: "#fff" }} />
                <span>Averages</span>
              </div>
            </div>
          </div>

          {/* Net Worth Pie Chart - Mobile Optimized */}
          <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-xl shadow-md border dark:border-gray-800 border-gray-200">
            <h2 className="text-lg sm:text-xl font-bold dark:text-gray-200 text-gray-800 mb-3">Account Distribution</h2>

            <p className="text-xs sm:text-sm dark:text-gray-200 text-gray-600 mb-4">
              Distribution of your wealth across different account types.
            </p>
          ...
          {/* Radar Chart - Mobile Optimized */}
          <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-xl shadow-md border dark:border-gray-800 border-gray-200">
            <h2 className="text-lg sm:text-xl font-bold dark:text-gray-200 text-gray-800 mb-3">Financial Health Radar</h2>

            <p className="text-xs sm:text-sm dark:text-gray-200 text-gray-600 mb-4">
              Visual representation of your financial health across different metrics.
            </p>
            ...
            <div className="mt-2 grid grid-cols-2 gap-2 text-center text-xs">
              {radarStats.map((stat, i) => (
                <div key={i} className="bg-gray-50 dark:bg-gray-700 p-1.5 rounded-lg">
                  <p className="font-medium truncate" title={stat.axis}>{stat.axis}</p>
          ...
          {/* Trend Line Chart - Mobile Optimized */}
          <div className="bg-white dark:bg-gray-800 dark:border-gray-800 p-4 sm:p-6 rounded-xl shadow-sm border border-gray-100">
            <div className="flex flex-col gap-3 mb-4">
              <div>
                <h2 className="text-lg sm:text-xl font-semibold dark:text-gray-200 text-gray-800 mb-1">Spending Trend</h2>
                <p className="text-xs sm:text-sm dark:text-gray-200 text-gray-500">
                  Monthly trends this year with volatility and changes.
                </p>
              </div>
              
              <div className="bg-indigo-50 rounded-lg px-2 py-1.5 text-indigo-700 text-xs font-medium">
                Your spending: <span className="font-semibold">{trend?.behavioralTags.slice(0, 2).join(", ")}</span>
              </div>
            </div>
            ...
            <div className="h-64 sm:h-80 mb-2">
              <ResponsiveContainer width="100%" height="100%">
                <ComposedChart data={data} margin={{ top: 8, right: 15, left: 5, bottom: 5 }}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#f3f4f6" />
                  <XAxis dataKey="month" tick={{ fontSize: 10, fill: "#6b7280" }} />
                  <YAxis yAxisId="left" tickFormatter={currencyTick} tick={{ fontSize: 9, fill: "#6b7280" }} />
                  <YAxis
                    yAxisId="rightVol"
                    orientation="right"
                  ...
                  <Tooltip
                    ...
                    content={({ active, payload, label }) => {
                      ...
                      return (
                        <div className="rounded-lg border dark:bg-gray-700 dark:border-gray-700 border-gray-200 bg-white/95 backdrop-blur px-2 py-1 shadow-sm text-xs">
                          <div className="text-xs dark:text-gray-200 text-gray-500 mb-1">{label}</div>
                          {payload
                            .filter(p => p.value != null)
                            .map((p, idx) => (
                              <div key={idx} className="flex items-center gap-1 text-xs mb-1 last:mb-0">
                                <span className="inline-block h-2 w-2 rounded-full" style={{ background: p.color }} />
                                <span className="text-gray-600 dark:text-gray-200 truncate max-w-[60px]">{p.name || p.dataKey}</span>
                          ...
                          {row?.anomalies > 0 && (
                            <div className="mt-1 pt-1 border-t border-gray-100 text-xs text-red-600">
                              <div className="flex items-center gap-1">
                                <FaTimesCircle className="text-xs" /> {row.anomalies} anomaly{row.anomalies > 1 ? "ies" : "y"}
                              </div>
                            </div>
                          )}
                        </div>
            ...
            <div className="text-xs dark:text-gray-200 text-gray-400 mb-3">
              Delta = change vs last month. Volatility = expense spread.
            </div>
              ...
              <ul className="space-y-1">
                {!!trend?.categoryShift?.changed && (
                  <li className="flex items-start">
                    <span className="w-1 h-1 rounded-full bg-gray-400 mt-1.5 mr-1.5 flex-shrink-0"></span>
                    <span className="text-xs">
                      Top category: <span className="font-medium">{trend.categoryShift.current}</span>
                    </span>
                  </li>
                )}
                {Array.isArray(trend?.anomalies) && trend.anomalies.length > 0 && (
                  <li className="flex items-start">
                    <span className="w-1 h-1 rounded-full bg-gray-400 mt-1.5 mr-1.5 flex-shrink-0"></span>
                    <span className="text-xs">Detected {trend.anomalies.length} unusual transactions</span>
                  </li>
                )}
                {!!trend?.spendingForecast?.next_month_forecast && (
                  <li className="flex items-start">
                    <span className="w-1 h-1 rounded-full bg-gray-400 mt-1.5 mr-1.5 flex-shrink-0"></span>
                    <span className="text-xs">
                      Next month: <span className="font-medium">
          ...
          {/* Heatmap Chart - Mobile Optimized */}
          <div className="bg-white p-4 sm:p-6 rounded-xl shadow-md border dark:border-gray-800 dark:bg-gray-800 dark:text-gray-200 border-gray-200 lg:col-span-2">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
              <div>
                ...
                <p className="text-xs sm:text-sm dark:text-gray-200 text-gray-500">
                  Daily transaction activity over the past year.
                </p>
              </div>
              ...
              <div className="inline-flex rounded-md border border-gray-300 overflow-hidden self-start">
                <button
                  ...
                  className={`px-2 py-1 text-xs sm:text-sm ${mode === "count"
                ...
                <button
                  ...
                  className={`px-2 py-1 text-xs sm:text-sm border-l border-gray-300 ${mode === "amount"
                    ? "bg-blue-200 text-blue-800"
            ...
            <div className="overflow-x-auto pb-2 -mx-2 px-2">
              <div className="min-w-[600px]">
                <CalendarHeatmap
                  ...
                  weekdayLabelClass="text-[0.5rem] dark:text-gray-200 text-gray-500" 
                  monthLabelClass="text-[0.5rem] dark:bg-gray-700 dark:text-gray-200 text-gray-500"
                />
              </div>
            </div>

            <div className="mt-4 flex items-center flex-wrap gap-1 text-xs dark:text-gray-200 text-gray-600">
              <span className="opacity-70">Less</span>
              <span className="inline-block w-2 h-2 rounded bg-blue-100 border border-gray-200" />
              <span className="inline-block w-2 h-2 rounded bg-blue-200 border border-gray-200" />
              <span className="inline-block w-2 h-2 rounded bg-blue-300 border border-gray-200" />
              <span className="inline-block w-2 h-2 rounded bg-blue-400 border border-gray-200" />
              <span className="inline-block w-2 h-2 rounded bg-blue-600 border border-gray-200" />
              <span className="opacity-70">More</span>

              <span className="ml-2 opacity-60 text-xs">
                {mode === "amount"
                  ? `≤R${thresholds[1]}, ≤R${thresholds[2]}, ≤R${thresholds[3]}, >R${thresholds[3]}`
