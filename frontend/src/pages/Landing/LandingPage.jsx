...
const team = [
    { name: "Yohali Malaika Kumangu", role: "Frontend Lead", github: "https://github.com/alice", linkedin: "https://linkedin.com/in/alice" },
    { name: "Lebogang Masenya", role: "Backend Engineer", github: "https://github.com/bob", linkedin: "https://linkedin.com/in/bob" },
    { name: "Mpho Siminya", role: "AI/ML Developer", github: "https://github.com/carol", linkedin: "https://linkedin.com/in/carol" },
    { name: "Nobuhle Mtshali", role: "AR/UX Designer", github: "https://github.com/dave", linkedin: "https://linkedin.com/in/dave" },
    { name: "Aundrea Ncube", role: "Fullstack Developer", github: "https://github.com/eve", linkedin: "https://linkedin.com/in/eve" },
];
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-200 to-gray-100 text-white font-pixel">
            <header className="p-6 flex justify-between items-center shadow-md bg-black/80 sticky top-0 z-50">
                <h1 className="text-5xl font-bold text-lime-400 drop-shadow-md animate-pulse">Gamified Finance</h1>
                <Button variant="outline" className="text-white border-lime-400 hover:bg-lime-500 hover:text-black transition duration-300" onClick={() => window.location.href = '/login'}>
                    Enter Portal
                </Button>
            </header>
            ...
            <section className="text-center py-24 px-6 bg-gradient-to-br from-blue-100/10 via-purple-200/10 to-pink-300/10">
                <h2
                    className="text-6xl font-extrabold text-lime-400 animate-bounce"
                    style={{
            ...
            <section className="py-20 px-6 bg-gray-100">
                <h3 className="text-4xl font-bold text-lime-300 mb-12 text-center">Core Features</h3>
            ...
            <section className="py-20 px-6 bg-gradient-to-tr from-gray-100 via-gray-100 to-white">
                <h3 className="text-4xl font-bold text-lime-400 mb-10 text-center">Powered by Cutting Edge Tech</h3>
            ...
            <section className="py-24 px-6 bg-gray-100">
                <h3 className="text-4xl font-bold text-lime-300 mb-14 text-center">Meet the Codeblooded Heroes</h3>
            ...
            <section className="text-center py-16 px-4 bg-gradient-to-br from-lime-700/80 via-white to-lime-600/90">
...
function Feature({ icon, title, desc }) {
    return (
        <div className="bg-gray-100 p-6 rounded-xl border border-lime-400 text-center shadow-md hover:shadow-lime-400/40 transition-all duration-300">
            <div className="text-5xl mb-4 text-lime-300">{icon}</div>
